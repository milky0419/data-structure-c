...
/* ===== 맨 앞/뒤 삽입 ===== */
void dll_push_front(DLLP* list, int value); // 맨 앞 삽입
void dll_push_back(DLLP* list, int value); // 맨 뒤 삽입

/* ===== 맨 앞/뒤 삭제 ===== */
int dll_pop_front(DLLP* list, int* out); // 맨 앞 삭제: 성공 시 1, 실패 시 0
int dll_pop_back(DLLP* list, int* out); // 맨 뒤 삭제: 성공 시 1, 실패 시 0
