...
int ll_push_back(LLP* list, int value); // 맨 뒤 삽입: 성공 시 1, 실패 시 0 반환

/* ===== 맨 앞/뒤 삭제 ===== */
int ll_pop_front(LLP* list, int* out); // 맨 앞 삭제: 성공 시 1, 실패 시 0 반환
int ll_pop_back(LLP* list, int* out); // 맨 뒤 삭제: 성공 시 1, 실패 시 0 반환
